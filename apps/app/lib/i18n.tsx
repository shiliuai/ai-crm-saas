...
const en = {
  ...
  crm: {
    title: "CRM",
    description: "Track customers across a simple sales pipeline.",
    addCustomer: "Add customer",
    customerPlaceholder: "Customer name or company",
    searchPlaceholder: "Search customers...",
    totalCustomers: "Customers",
    openPipeline: "Open pipeline",
    wonCustomers: "Won customers",
    dragHint: "Drag customer cards between stages.",
    lead: "Lead",
    qualified: "Qualified",
    proposal: "Proposal",
    won: "Won",
...
const zh: typeof en = {
  ...
  crm: {
    title: "CRM",
    description: "用简洁销售管道跟进客户。",
    addCustomer: "添加客户",
    customerPlaceholder: "客户姓名或公司",
    searchPlaceholder: "搜索客户...",
    totalCustomers: "客户数",
    openPipeline: "推进中",
    wonCustomers: "已成交",
    dragHint: "拖拽客户卡片即可移动阶段。",
    lead: "线索",
    qualified: "已确认",
    proposal: "方案",
    won: "成交",
    addToStage: "添加到{stage}",
    noCustomers: "暂无客户",
    noMatches: "没有匹配客户",
  },
  analytics: {
